...
# Load simulated data using here() to locate files in data/
comm <- read.csv(here("data", "desert_community_matrix.csv"), row.names = 1)
env  <- read.csv(here("data", "desert_environmental_data.csv"), row.names = 1)
